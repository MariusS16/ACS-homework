    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
			...
			glm::mat3 rotationMatrix = glm::mat3(glm::rotate(glm::mat4(1), angle, glm::vec3(1, 0, 0)));
        ...
        void RotateFirstPerson_OY(float angle)
        {
			...
			glm::mat3 rotationMatrix = glm::mat3(glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0)));
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::mat3 r = glm::mat3(glm::rotate(glm::mat4(1), angle, glm::vec3(0, 0, 1)));
